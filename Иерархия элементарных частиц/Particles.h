...
public:
    Particle(bool isStable, bool hasMass, int spin, double elCharge, double E0 = 0,
             double timeOfLife = std::numeric_limits<double>::infinity()) :
...
public:
    Lepton(bool isStable, double elCharge, double E0, double timeOfLife = std::numeric_limits<double>::infinity()) : Fermion(isStable, true, 0, elCharge, E0, timeOfLife) {}
